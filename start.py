...
def main():
    ...
    while True:
        ...
        match action:
            case 'Получить балансы кошельков':
                get_balances(wallets)
            case 'Получить баланс конкретного токена':
                ticker = get_ticker()
